module.exports = function(SerialPort, xbee_api, firebase, pro) {
   ...
   function xbeeNew(comName) {
      ...
      var bus_dataRef = db.ref("/bus_data"); // creates a database reference at the root node
      ...
      xbeeAPI.on("frame_object", function(frame) {
         ...
         var iden = xbee_data.split(','); // ["IDEN(1)", "TIME(20:55:40)", "DATE(10/31/16)", ...]
         if (iden[3].charAt(5) == '0')
