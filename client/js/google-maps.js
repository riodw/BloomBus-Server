...
var database = firebase.database().ref('/' + getNewTime());

var colors = ['red', 'blue', 'green', 'yellow', 'cyan', 'magenta']; // For Map markers
...
function initMap() {
    ...
    // Starting Position
    var latlng = new google.maps.LatLng('41.008528', '-76.446415');
    // Google Maps Options
    var myOptions = {
        zoom: 17,
        center: latlng,
